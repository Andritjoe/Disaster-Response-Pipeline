...
def index():
    ...
    aid_rel = df[df['aid_related']==1].groupby('genre').count()['message']
    aid_non_rel = df[df['aid_related']==0].groupby('genre').count()['message']
    ...
    graphs = [
        {
            'data': [
                ...
                Bar(
                    x=genre_names,
                    y= aid_non_rel,
                    name = 'Non Aid-related'
                )
            ],

            'layout': {
                'title': 'Distribution of message by genre and \'aid or non-aid\' class ',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
